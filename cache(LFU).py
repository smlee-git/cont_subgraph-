...
def loadPrefetchedCache2(pCache, uCache, nodeId, th) :
            ...
            if ccres is None :
                ...
                for line in ccres['e'] :
                    ...
                    for j in joinResult :
                        ...
                        currentNode_last_id = j[-1]
                        # print('현재 노드 마지막 :',currentNode_last_id)
                        if childrenNode_first_id == currentNode_last_id : # 자식 노드의 현재 = 현재 노드의 마지막
                            res = j.copy()
                            res.append(childrenNode_last_id)
                            # print('=================================================res : ', res)
                            jjoinResult.append(res)
...
with open("datafile_youtube.txt", "r") as f:
    last_time = 0
    cnt = 0
    start = time.time()
    total_start = start
    ...
    while 1 :
        ...
        for currentNode in currentNodes :
            ...
            if cres is None:
                ...
                # uCache[currentNode.id] = {'e' : deque(), 'r' : deque(), 'TTL' : 0, "edge_size": 0, "result_size": 0}
